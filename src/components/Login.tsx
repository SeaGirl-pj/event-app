      ...
      <div className="w-full max-w-6xl grid md:grid-cols-2 gap-8 items-center">
        ...
        <div className="hidden md:block space-y-6">
          ...
          <div className="flex gap-4 pt-4">
            <div className="flex items-center gap-2">
              <div className="w-10 h-10 bg-[#FF7A33]/20 rounded-full flex items-center justify-center">
                <Sparkles className="w-5 h-5 text-[#FF7A33]" />
              </div>
              <div>
            ...
            <div className="flex items-center gap-2">
              <div className="w-10 h-10 bg-[#1D6FD8]/20 rounded-full flex items-center justify-center">
                <Calendar className="w-5 h-5 text-[#1D6FD8]" />
              </div>
              <div>
        ...
        <Card className="p-8 shadow-xl">
          <div className="mb-6">
            ...
            <p className="text-gray-600">Sign in to continue to EventConnect</p>
          </div>
