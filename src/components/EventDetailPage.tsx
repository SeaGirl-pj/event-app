      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <Card className="p-6">
              ...
              <div className="flex flex-wrap gap-2">
                {event.tags.map((tag, index) => (
                  <Badge key={index} variant="outline" className="text-[#1D6FD8] border-[#1D6FD8]">
                    {tag}
                  </Badge>
                ))}
              </div>
            ...
            {/* Speakers */}
            <Card className="p-6">
              <h2 className="mb-6">Featured Speakers</h2>
                ...
                {speakers.map((speaker) => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-[#FF7A33]">{speaker.topic}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            {/* Schedule */}
            <Card className="p-6">
              <h2 className="mb-6">Event Schedule</h2>
                  ...
                  <div key={index} className="flex gap-4">
                    ...
                    <div className="flex-1">
                      <div className="relative pl-6 pb-6 border-l-2 border-gray-200 last:border-0">
                        <div className="absolute left-0 top-2 -translate-x-1/2 w-4 h-4 rounded-full bg-gradient-to-br from-[#FF7A33] to-[#1D6FD8]"></div>
                        <h4 className="mb-2">{item.title}</h4>
                        <p className="text-sm text-gray-600">{item.description}</p>
                        {item.speaker && (
                          <Badge variant="outline" className="mt-2 text-[#FF7A33] border-[#FF7A33]">
                            {item.speaker}
                          </Badge>
                        )}
                      </div>
            ...
            <Card className="p-6">
              ...
              <p className="text-gray-600 mb-4 flex items-center gap-2">
                <MapPin className="w-4 h-4 text-[#FF7A33]" />
                {event.address}
              </p>
          ...
          <div className="space-y-6">
            ...
            {/* Organizer Info */}
            <Card className="p-6">
              <h4 className="mb-4">Organized By</h4>
        ...
        {/* Similar Events */}
        <div className="mt-12">
          <h2 className="mb-6">Similar Events You Might Like</h2>
